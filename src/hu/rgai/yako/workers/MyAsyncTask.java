 ...
 *
 * <p>AsyncTask is designed to be a helper class around {@link Thread} and Handler
...
public abstract class MyAsyncTask<Params, Progress, Result> {
   ...
   */
  public MyAsyncTask(final String s) {
    mWorker = new WorkerRunnable<Params, Result>(s) {
